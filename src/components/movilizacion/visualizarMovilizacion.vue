<template>
    ...
    <div class="row" v-if="!this.departamental" style="margin-top: 40px;">
        <div class="col-md-3">
          <h6>Departamentos:</h6>
        ...
        async getData() {
            ...
            if(rolF === "Departamento"){
                ...
                if(this.start_year == this.end_year){
                    const response = await fetch(`https://localhost:7192/api/filterAnioDepartamentoVisualizar/${this.start_year}/${this.id}/${this.token}?departamentos=${departamento}`, 
                    if(response.ok){
                        this.Num_Encuentros = response.Num_Encuentros;
                        this.Num_Premios_Grupos_Investigacion = response.Num_Premios_Grupos_Investigacion;
                        this.Num_Vinculados_Ferias = response.Num_Vinculados_Ferias;
                        this.Num_Vinculados_Internacionales = response.Num_Vinculados_Internacionales;
                        this.Num_Proyectos_Internacionales = response.Num_Proyectos_Internacionales;
                        this.Num_Grupos_Ganadores = response.Num_Grupos_Ganadores;
                        this.Num_Proyectos_Ferias = response.Num_Proyectos_Ferias;
                        this.Num_Vinculados_Conflicto_Armado = response.Num_Vinculados_Conflicto_Armado;
                        this.Num_Vinculados_Reincorporacion = response.Num_Vinculados_Reincorporacion;
                        this.Num_Vinculados_Etnia = response.Num_Vinculados_Etnia;
                        this.Num_Vinculados_Pdet = response.Num_Vinculados_Pdet;
                        this.Num_Vinculados_Zomac = response.Num_Vinculados_Zomac;
                        this.Num_Vinculados_Indigena = response.Num_Vinculados_Indigena;
                        this.Num_Vinculados_Gitano = response.Num_Vinculados_Gitano;
                        this.Num_Vinculados_Raizal = response.Num_Vinculados_Raizal;
                        this.Num_Vinculados_Palenquero = response.Num_Vinculados_Palenquero;
                        this.Num_Vinculados_Afro = response.Num_Vinculados_Afro;
                        this.Num_Vinculados_Discapacidad = response.Num_Vinculados_Discapacidad;
                    }
                );}
                else if(this.end_year > this.start_year){
                    const response = await fetch(`https://localhost:7192/api/filterAnioDepartamentoVisualizar/${this.start_year}/${this.end_year}/${this.id}/${this.token}?departamentos=${departamento}`, {
                    method: 'GET',
                    headers: {
                ...
                if(this.start_year == this.end_year){
                    const response = await fetch(`https://localhost:7192/api/filterAnioDepartamentoVisualizar/${this.start_year}/${this.id}/${this.token}?departamentos=${departamentos}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    ...
                    const response = await fetch(`https://localhost:7192/api/filterAniosDepartamentosVisualizar/${this.start_year}/${this.end_year}/${this.id}/${this.token}?departamentos=${departamentos}`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'application/json'
                    },
