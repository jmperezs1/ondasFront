<template>
    <h1 style="margin-top: 40px; text-align: center;">Visualizar Convocatoria</h1>
    <div>
        <div class="row" style="margin-top: 40px">
            ...
            <div class="col-md-3">
                <input type="number" placeholder="Ingrese el año de fin" class="form-control" @change="getDatos" id="endYear" v-model.number="endYear" min="1900" max="2099" step="1" style="border: 0;" :style="{border: (endYear < 1900 || endYear > 2099) ? '1px solid red' : ''}">
            </div>
        </div>
    </div>
