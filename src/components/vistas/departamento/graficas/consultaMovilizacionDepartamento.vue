    ...
    methods: {
        ...
        async generateGraph() {
            try {
                ...
                const response = await fetch(`${this.$baseRoute}/Movilizaciones/getAllMovilizaciones/${startYear}/${endYear}/${this.userId}/${this.token}?departamentos=${this.departamento}`);
