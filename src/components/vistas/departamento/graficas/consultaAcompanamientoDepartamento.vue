<template>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-5">Indicadores de Acompañamiento</h1>
        <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <ConsultarAcompanamiento v-if="generar && datos" :datos="datos" />
...
import ConsultarAcompanamiento from '@/components/graficas/consultarAcompanamiento.vue';
    ...
    methods: {
        ...
        async generateGraph() {
            try {
                ...
                const response = await fetch(`${this.$baseRoute}/Acompaniamientos/getAllAcompaniamientos/${startYear}/${endYear}/${this.userId}/${this.token}?departamentos=${this.departamento}`);
