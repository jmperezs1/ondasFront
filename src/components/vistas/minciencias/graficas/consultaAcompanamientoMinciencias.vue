    ...
    methods: {
        ...
        async generateGraph() {
            try {
                ...
                const response = await fetch(`${this.$baseRoute}/Acompaniamientos/getAllAcompaniamientos/${startYear}/${endYear}/${this.userId}/${this.token}?departamentos=${departamentos}`);
